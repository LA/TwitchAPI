...
function layoutUsers(data) {
    data.forEach(function(element) {
        if (element.hasOwnProperty("stream")) {
            if (element.stream !== null) {
                if (element.stream.hasOwnProperty("display_name")) {
                    createLiveUser(element);
                }
            } else {
                createOfflineUser(element);
            }
        } else {
...
function createLiveUser(element) {
    var display_name = element.stream.display_name;
    var logo = element.stream.logo;
    var status = element.stream.status;
